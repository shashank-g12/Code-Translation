...
if __name__ == "__main__":
    ...
    if args.dataset == "codenet":
        # dataset = load_dataset("iidai/codenet",cache_dir="/home/cse/dual/cs5190439/.cache/huggingface/datasets")['train']
        dataset = load_from_disk("/scratch/cse/dual/cs5190439/MTP1/PLTranslation_data/dataset/codenet_dataset")['train']
        dataset_name = "codenet"
    elif args.dataset == "avatar":#special 249 case prev codeforces_373_B
        # dataset = load_dataset("iidai/avatar",cache_dir="/home/cse/dual/cs5190439/.cache/huggingface/datasets")['train']
        dataset = load_from_disk("/scratch/cse/dual/cs5190439/MTP1/PLTranslation_data/dataset/avatar_dataset")['train']
        dataset_name = "avatar"
