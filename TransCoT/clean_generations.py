...
def clean_new_models(dataset):#granite-20b-code-instruct
    ...
    main_path = f"/scratch/cse/dual/cs5190439/MTP1/PLTranslation_data/codetlingua/{args.approach}/{dataset}/{args.model}/{args.source_lang}/{args.target_lang}/temperature_0"
        ...
        if os.path.isdir(dir_path):  # Check if it's a directory
            ...
            if os.path.isfile(target_file_path):  # Check if the file exists
                ...
                if (args.approach!="vanilla"):
                    ...
                    if (args.approach=="autocot1"):
                        data = data[data.find(f"3. Whole {source_lang} Code:")+len(f"3. Whole {source_lang} Code:"):]
                        data = data[data.find(f"3. Whole {target_lang} Code:")+len(f"3. Whole {target_lang} Code:"):]
...
'''
python3 /home/cse/dual/cs5190439/MTP1/codetlingua/clean_generations.py --source_lang Python --target_lang Java --model codellama-13b-instruct-hf --approach autocot2d --dataset codenet
