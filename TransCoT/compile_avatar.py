...
python3 /home/cse/dual/cs5190439/MTP1/codetlingua/compile_avatar.py --source_lang Python --target_lang Java --model granite-20bb-code-instruct --approach vanilla
